...
<CompareImage
  ...
  imageOneAlt="Unreal landscape painted with terrain type materials, before hex tile placement"
  imageTwo="/images/unreal-comp-photo-image2.jpg"
  imageTwoAlt="The same landscape with hexagonal tiles placed at sampled elevation levels"
/>
