...
<FullWidthImage
  src="/images/BP_Bag_prototype.png"
  alt={"Blueprint class hierarchy: a Base Item blueprint with subclassed blueprints for bags and other special items"}
/>
...
<FullWidthImage
  src="/images/item-example-hammer.png"
  alt={"Unreal editor details panel showing an example hammer item's data asset properties"}
/>
Instead of having to remember to do something like this each time I wanted to set up a container with an item:
<FullWidthImage
  src="/images/Avoid-doing-this.png"
  alt={"Screenshot of a verbose manual container setup in the editor, captioned as a pattern to avoid"}
/>
...
<FullWidthImage
  src="/images/item-instance-uml.png"
  alt={"UML diagram separating read-only ItemArchetype data from mutable runtime ItemInstances"}
/>

## Before and After
I'll end with some examples of the new Item Definitions:
<FullWidthImage
  src="/images/item-16-slot-bag.png"
  alt={"Item definition for a 16-slot bag, shown in the Unreal editor inspector"}
/>
<FullWidthImage
  src="/images/item-spiked-hammer.png"
  alt={"Item definition for a spiked hammer weapon, shown in the Unreal editor inspector"}
/>
<FullWidthImage
  src="/images/item-tome-of-lightning-rift.png"
  alt={"Item definition for a Tome of Lightning Rift spellbook, shown in the Unreal editor inspector"}
/>

And one last picture of how items looked in the inspector before this change:
<FullWidthImage
  src="/images/item-tome-of-lightning-rift-before.png"
  alt={"The same Tome of Lightning Rift item as it appeared in the inspector before the data asset rework, with more clutter"}
/>
Good riddance!
